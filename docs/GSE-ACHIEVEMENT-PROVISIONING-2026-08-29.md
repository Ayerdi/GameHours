...
The branch contains documentation-only commits after that functional head. They do not change runtime behavior; normal PR CI must still remain green for the current branch baseline before manual validation begins.
